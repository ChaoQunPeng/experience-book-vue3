 ...
 * @LastEditTime: 2024-02-01 16:41:51
 * @FilePath: /experience-book-vue3/src/utils/exp-helper.js
 * @Description: 
 */
export function getPhaseInfo(totalExp) {
 ...
 * @return {*}
 */
export function getLevelInfo(totalExp, expRange, levelName, levelExp) {
  const data = {
    name: levelName,
    level: 0,
    romanNum: 0,
...
export function getProgressLength(totalExp, levelData) {
  // totalExp 可能为null,即0
  // [0,199]  (2-0) / 199
